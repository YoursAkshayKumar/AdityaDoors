  ...
  try {
    ...
    if (user) {
      ...
      const mailData = {
        ...
        <p>Verify your email address to complete the signup and login into your <strong>Aditya Doors</strong> account.</p>
          ...
          <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@adityadoors.in</p>
  
          <p style="margin-bottom:0px;">Thank you</p>
          <strong>Aditya Doors Team</strong>
           `,
      };
  ...
  try {
    ...
    if (!user) {
      ...
      const body = {
        ...
        <p>A request has been received to change the password for your <strong>Aditya Doors</strong> account </p>
